...
#===============================================================================
# Axon-Loop 状态管理脚本
# 用法: ././_axon/scripts/axon-loop.sh <command> [options]
#
# 命令:
#   status          显示当前状态
#   backup          手动备份当前状态
...
#
# 示例:
#   ././_axon/scripts/axon-loop.sh status
#   ././_axon/scripts/axon-loop.sh backup
#   ././_axon/scripts/axon-loop.sh restore ./_axon/loop/runs/2026-03-18-100000/
#   ././_axon/scripts/axon-loop.sh clean 7
#===============================================================================
...
示例:
  ././_axon/scripts/axon-loop.sh status              # 查看状态
  ././_axon/scripts/axon-loop.sh backup             # 备份
  ././_axon/scripts/axon-loop.sh restore runs/xxx/   # 恢复
  ././_axon/scripts/axon-loop.sh clean 7            # 删除 7 天前备份

详细文档: ./_axon/loop/PROTOCOL.md
EOF
}
...
#-------------------------------------------------------------------------------
cmd_init() {
    if [[ -x "././_axon/scripts/init-axon-loop.sh" ]]; then
        ././_axon/scripts/init-axon-loop.sh "$@"
    else
