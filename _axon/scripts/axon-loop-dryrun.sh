...
#
# 用法:
#   ././_axon/scripts/axon-loop-dryrun.sh < task-list.md
#   ././_axon/scripts/axon-loop-dryrun.sh --file task-list.md
#   ././_axon/scripts/axon-loop-dryrun.sh --check-state
#===============================================================================
...
用法:
    ././_axon/scripts/axon-loop-dryrun.sh [options]
...
示例:
    ././_axon/scripts/axon-loop-dryrun.sh
    ././_axon/scripts/axon-loop-dryrun.sh --file task-list.md
    ././_axon/scripts/axon-loop-dryrun.sh --check-state
    ...
    if $check_state; then
        ...
        if [[ -z "$task_list" ]]; then
            ...
            if [[ -t 0 ]]; then
                ...
                info "示例: ././_axon/scripts/axon-loop-dryrun.sh < task-list.md"
                echo ""
                show_help
                exit 0
            fi
