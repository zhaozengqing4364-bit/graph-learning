...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Install the Codex growth-architect workflow into another project."
    )
...
def main() -> int:
    ...
    template_root = script_dir.parent / "templates" / "codex-growth-architect"
    ...
    for destination, rendered in planned_writes:
        ...
        if destination.name == "codex-growth-plan.sh":
    ...
    if planned_writes:
        ...
        print("Next steps:")
        print(
            f"1. Fill {target_root / '.codex/roadmap/PROJECT_FUTURE.md'} with the real product promise and growth priorities."
        )
        print("2. Run scripts/codex-growth-plan.sh to generate a fresh roadmap.")
        print("3. Feed the best roadmap items into your single-item execution workflow, such as safe-grow.")
    else:
